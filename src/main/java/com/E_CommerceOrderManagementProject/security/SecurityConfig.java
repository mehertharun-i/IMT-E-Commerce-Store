...
public class SecurityConfig {
	...
	public SecurityFilterChain secuirtyFilterChain(HttpSecurity httpSecurity) throws Exception {
		return httpSecurity
						...
						.authorizeHttpRequests(auth -> auth.requestMatchers("/user/insertuserdetails", "/user/login")
															.permitAll()
															.requestMatchers("/order/**").hasAnyRole("USER", "ADMIN")   
															.requestMatchers("/user/**").hasAnyRole("ADMIN")
															.requestMatchers("/product/**").hasRole("SELLER")
															.requestMatchers("/test/hi").hasRole("OPS")
															.requestMatchers("/test/**").hasRole("DBADMIN")
															.anyRequest()
															.authenticated())
